...
const HeroSection = () => {
  return (
    <div className="flex flex-col items-center mt-6 lg:mt-20">
        ...
        <p className='mt-10 text-lg text-center max-w-4xl text-neutral-500'>Empower your creativity and bring your VR app ideas to life with our intuitive development tools. 
